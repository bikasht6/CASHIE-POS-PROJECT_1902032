			...
			<Container >
				<Grid container>
					<Grid item lg={4} md={6} xs={12}>
						<Paper className="d-sm-cards maroon-card" style= {{backgroundColor:'#D9CAB3'}}>
							<h3>{dashboardData && dashboardData.count}</h3>
							<h5>Transactions</h5>
						</Paper>
					</Grid>
					<Grid item lg={4} md={6} xs={12}>
						<Paper className="d-sm-cards indigo-card" style = {{backgroundColor:'#87A8A4'}}>
							<h3>{dashboardData && dashboardData.total.toFixed(2)}</h3>
							<h5>Income</h5>
						</Paper>
					</Grid>
					<Grid item lg={4} md={6} xs={12}>
						<Paper className="d-sm-cards orange-card" style = {{backgroundColor:'#986D8E'}}>
